...
data class GovernmentVehicle(val id: String, val type: String, val brand: String, val color: String, val weight: Int,
    ...
    constructor(ownership: Ownership) : this(ownership.vehicle.id, ownership.vehicle.type, ownership.vehicle.brand, ownership.vehicle.color, ownership.vehicle.weight, ownership.startDate, ownership.endDate, ownership.vehicle.carTracker?.id, ownership.vehicle.rate)
}